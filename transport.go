...
//}
//
//// AcceptSession connects to the remote agent, acting as the controlled ice agent.
//// AcceptSession blocks until at least one ice candidate pair has successfully connected.
//func (a *Agent) AcceptSession(ctx context.Context, remoteUfrag, remotePwd string) (*Conn, error) {
