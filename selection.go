...
//	HandleBindingRequest(m *stun.Response, local, remote Candidate)
//}
//
...
//	agent := c.Component().Stream.Agent
//
//	switch {
//	case c.Type() == CandidateTypeHost:
//		return time.Since(s.startTime).Nanoseconds() > agent.hostAcceptanceMinWait.Nanoseconds()
//	case c.Type() == CandidateTypeServerReflexive:
//		return time.Since(s.startTime).Nanoseconds() > agent.srflxAcceptanceMinWait.Nanoseconds()
//	case c.Type() == CandidateTypePeerReflexive:
//		return time.Since(s.startTime).Nanoseconds() > agent.prflxAcceptanceMinWait.Nanoseconds()
//	case c.Type() == CandidateTypeRelay:
//		return time.Since(s.startTime).Nanoseconds() > agent.relayAcceptanceMinWait.Nanoseconds()
//	}
//
...
//}
//
//func (s *controllingSelector) HandleBindingRequest(m *stun.Response, local, remote Candidate) {
...
//}
//
//func (s *controllingSelector) HandleSucessResponse(m *stun.Response, local, remote Candidate, remoteAddr net.Addr) {
...
//}
//
//func (s *controlledSelector) HandleSucessResponse(m *stun.Response, local, remote Candidate, remoteAddr net.Addr) {
...
//}
//
//func (s *controlledSelector) HandleBindingRequest(m *stun.Response, local, remote Candidate) {
